...
// Debug. This should never run unless you actually run this script, rather than require it.
session_start();
user_retrieve();
echo "user data: " . $user_id = $_SESSION[ 'user_id' ] . " " . $_SESSION[ 'email' ] . " " . $_SESSION[ 'fname' ] . " " . $_SESSION[ 'lname' ];
